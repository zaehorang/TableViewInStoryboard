...
class ViewController: UIViewController, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return moviewDataArray.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "MovieCell", for: indexPath) as! MovieCell
        
        cell.mainImageView.image = moviewDataArray[indexPath.row].movieImage
        cell.movieNameLabel.text = moviewDataArray[indexPath.row].movieName
        cell.descriptionLabel.text = moviewDataArray[indexPath.row].movieDescription
